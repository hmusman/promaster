...
<div class="row">
    <div class="col-md-8  no-padding">
        <section class="pos_banner_area" style="margin-top: 86px">
            <div class="pos_slider owl-carousel">
                <div class="pos_banner_item" style="background: url({{url('public/assets/img/seo/eBook1.jpg')}});background-size:cover; background-position: center;"></div>

            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12 seo_banner_content main">
                        <h2 class="wow fadeInUp" data-wow-delay="0.3s">Let’s stay in and read</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.5s"> We have created ebooks to bring you great content to advance your career</p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="col-md-4 no-padding">
        <section class="pos_banner_area new m_80">
            <div class="pos_slider owl-carousel">
                <div class="pos_banner_item" style="background: url({{url('public/assets/img/seo/eBook2.jpg')}});background-size:cover; background-position: center;"></div>

            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12 seo_banner_content">
                        <h4 class="wow fadeInUp" data-wow-delay="0.3s">Keep learning with useful career eBooks</h4>
        ...
        <section class="pos_banner_area new">
            <div class="pos_slider owl-carousel">
                <div class="pos_banner_item" style="background: url({{url('public/assets/img/seo/eBook3.jpg')}});background-size:cover; background-position: center;"></div>
...
<section class="app_screenshot_area sec_pad">
    <div class="container custom_container p0">
        <div class="sec_title mb-2">
            <h4 class="f_p f_size_30 l_height30 f_700 t_color3 mb_20 wow fadeInUp" data-wow-delay="0.2s">Trending Now in eBooks<span class="view-all"><a class="cart-link" href="{{ route('trendingEbooks') }}">View All</a></span></h4>
            ...
            <div class="app_screenshot_slider owl-carousel">
                ...
                <!-- <div class="item">
                    ...
                    <div class="book-about">
                        ...
                        <p>Professional eBook</p>
                        <img src="https://getphotostick.io/wp-content/uploads/fourhalf-stars-1.jpg">
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                $.ajax({
                    ...
                    success: function(response){
                       window.location.href = "https://promastersgips.com/ebooks";
                       $.toast({
