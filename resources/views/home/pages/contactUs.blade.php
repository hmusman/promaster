            ...
            <div class="container">
                <div class="row">
			            ...
			            @endif
                          <h2 class="f_p f_700 f_size_40 t_color3 mb_20">Contact Us</h2>
                           <div class="contact_form">
                            <form action="{{route('sendMessage')}}" class="contact_form_box" method="post" id="contactForm" novalidate="novalidate">
                            	@csrf
                                <div class="row">
                                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-4 d-flex align-items-center">
                        <div class="login_img">
                            <img src="{{url('public/assets/img/seo/contact.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
