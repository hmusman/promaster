    ...
    <div class="container">
        <div class="row">
                    ...
                    <form action="{{url('register-user')}}" method="POST" class="login-form mt_60" id="signup-form">
                        ...
                        <div class="form-group text_box">
                            <label class="f_p text_c f_400">Gender</label>
                             <select class="form-control shadow-sm p-3 mb-5 bg-white rounded" name="gender">
                        ...
                        <div class="form-group text_box">
                            ...
                            <select class="form-control shadow-sm p-3 mb-5 bg-white rounded"  name="country" >
                        ...
                        <button type="submit" class="btn_three form-submit-btn">Create Account</button>
            ...
            <div class="col-lg-4 d-flex align-items-center">
                <div class="login_img">
                    <img src="{{url('public/assets/img/seo/signup.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade support" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    It is the Promasters: Global Institute for Professional Studies’ policy and responsibility to
                    provide excellent service to the public. Customer feedback help us measure whether our services are
                    meeting public needs and expectations. It also helps us identify problems that need to be solved.
                    High quality customer service depends on customer feedback. While praise is always welcome,
                    constructive criticism is truly helpful in the long run.</p>

                <p>Promasters: Global Institute for Professional Studies strives for excellence and professionalism in
                    providing customer service, both inside and outside the organization, within the limits of
                    available, well-managed sources.</p>
                ...
                <ul>
                    ...
                    <li>Listening carefully and giving full consideration to the requests and concerns of our customers
                    </li>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>When you create an account and use the Services, including through a thirdparty platform, we collect
                    any information you provide directly, including:</p>
                <ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    ...
                    <li>In any way use the Services to send deceptive, altered, or false sourceidentifying information
                        (such as appearing as Promasters to send false
