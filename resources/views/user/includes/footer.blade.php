		      ...
		      <div class="row">
		        <div class="col-md-6">
		          <div class="text-center text-md-left">
		              <p class="mb-0"> © Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span>. <a href="{{url('user/courses')}}"> Promasters </a> All Rights Reserved. </p>
		          </div>
		        </div>
		        <div class="col-md-6">
...
<script>var plugin_path = "{{url('public/assets/js')}}";</script>
